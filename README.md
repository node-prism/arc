...
If you'd prefer to run this as a self-contained service within your stack that accepts connections over TCP, authenticates them, and receives and responds to queries in this manner, you may want to use [arc-server](https://github.com/node-prism/arc-server). It has a particular stance in the way it handles authentication and messaging in general, so if it does not meet your expectations, you may consider developing your own service-based solution.
