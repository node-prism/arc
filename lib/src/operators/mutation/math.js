...
function math(source, modifiers, query, op, collection) {
    ...
    const operable = returnFound(source, query, {
        deep: true,
        returnKey: ID_KEY,
        clonedData: false,
    });
...
export function $inc(source, modifiers, query, collection) {
    return math(source, modifiers, query, Op.Inc, collection);
}
export function $dec(source, modifiers, query, collection) {
    return math(source, modifiers, query, Op.Dec, collection);
}
export function $mult(source, modifiers, query, collection) {
    return math(source, modifiers, query, Op.Mult, collection);
}
export function $div(source, modifiers, query, collection) {
    return math(source, modifiers, query, Op.Div, collection);
}
